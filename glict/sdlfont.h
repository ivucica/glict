...
SDLFont *sdlFont_initFont(char *fontdir, float r, float g, float b, float a);

// Some overloaded functions to make your life easier
inline SDLFont *sdlFont_initFont(char *fontdir, float r, float g, float b) { return initFont(fontdir, r,g,b,1); }
inline SDLFont *sdlFont_initFont(char *fontdir) { return initFont(fontdir, 1,1,1,1); }

// This function draws a string
void sdlFont_drawString(SDL_Surface *screen, SDLFont *font, int x, int y, char *str,...);

// This function returns the width of a string
int sdlFont_stringWidth(SDLFont *font, char *str,...);

// This function destroys the font
void sdlFont_freeFont(SDLFont *font);
